...
summary(mod)
```
Donc au final, après analyse multivariée, il existe des différences de symptômes entre hommes et femmes qui ne sont pas expliquée par des différences de biomarqueurs (cette différence n'est dailleurs plus significative), les hommes ayant plus de syndromes parkinsoniens, et plus de RBD.
